...
import { PlusOutlined, DeleteOutlined, EnvironmentOutlined, RightOutlined } from '@ant-design/icons'
...
export const PublishProductPage: React.FC = () => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      const productData = {
        ...values,
        category: categoryValue, // 使用 "主分类/子分类" 格式
        location: locationLabels, // 使用中文标签
  ...
  return (
    <div className="publish-page fade-in">
      <div className="publish-container">
        <div className="publish-header glass-card" style={{ padding: '20px', borderRadius: '16px', marginBottom: '24px' }}>
        ...
        <div className="publish-content glass-card">
          <Form
            form={form}
            layout="vertical"
          ...
          >
            ...
            <div className="publish-section">
              ...
              {/* 智能定价助手 - 一键按钮 */}
              <div className="price-assistant-wrapper" style={{ marginBottom: '16px' }}>
                <PriceAssistant
